...
class UpdateButtons:
    ...
    def g10_update(self):
        ...
        g10_stat_label = tk.Label(self.window, text="Statistics", font=("Helvetica", 10))
        g10_stat_label.grid(row=8, column=1)
        g10_stat_minus_button = tk.Button(self.window, text="-", font=("Helvetica", 10), command=lambda: self.grade_change('-', UpdateButtons.g10_grades[8], g10_stat_grade_label, 8, 10))
        g10_stat_minus_button.grid(row=9, column=0)
        g10_stat_grade_label = tk.Label(self.window, text=f"{UpdateButtons.g10_grades[8]}", font=("Helvetica", 10))
        g10_stat_grade_label.grid(row=9, column=1)
        g10_stat_add_button = tk.Button(self.window, text="+", font=("Helvetica", 10), command=lambda: self.grade_change('+', UpdateButtons.g10_grades[8], g10_stat_grade_label, 8, 10))
        g10_stat_add_button.grid(row=9, column=2)
